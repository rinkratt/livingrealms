...
$downloadPath = dirname(__DIR__) . '/downloads/LivingRealms-Playtest-Windows-0.9.13.zip';
...
<div>
<p class="eyebrow">Build 0.9.13</p><h2>A shared world is waiting.</h2>
...
<h3>What changed in 0.9.13</h3><p>Darkwood raids and Stonehaven counterattacks now persist through assembling, marching, force-on-force combat, and structure destruction. A started campaign cannot vanish or expire; the server advances it to a recorded victory or defeat, and Journey shows the active phase and remaining force and structure strength.</p>
<h3>Automatic updates</h3><p>Build 0.9.13 checks for future builds when it starts. New packages are downloaded from living-realms.com, checksum-verified, installed, and relaunched automatically.</p>
