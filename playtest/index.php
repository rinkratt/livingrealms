...
$downloadPath = dirname(__DIR__) . '/downloads/LivingRealms-Playtest-Windows-0.9.16.zip';
...
<div>
<p class="eyebrow">Build 0.9.16</p><h2>A shared world is waiting.</h2>
...
<h3>What changed in 0.9.16</h3><p>Stonehaven and Darkwood now have separate banks with closed inventories. Each bank begins with no resources and can resell only supplies its own faction actually sold. Settlements automatically sell true surpluses and buy shortages only when their bank has stock and their treasury can pay. Journey shows both banks, gold balances, shelf inventory, reserve targets, shortages, prices, and recent Central-time transactions.</p>
<h3>Automatic updates</h3><p>Build 0.9.16 checks for future builds when it starts. New packages are downloaded from living-realms.com, checksum-verified, installed, and relaunched automatically.</p>
