...
$downloadPath = dirname(__DIR__) . '/downloads/LivingRealms-Playtest-Windows-0.9.9.zip';
...
<div>
<p class="eyebrow">Build 0.9.9</p><h2>A shared world is waiting.</h2>
...
<h3>What changed in 0.9.9</h3><p>Emberwing, a red dragon, and Nightveil, a black dragon, now roam independently through all nine grids. Both dragons use Idle, Walk, Run, and Fly modes with ground pathfinding, safe cross-grid flight, player clearance, dragon separation, and safe landing points.</p>
<h3>Automatic updates</h3><p>Build 0.9.9 checks for future builds when it starts. New packages are downloaded from living-realms.com, checksum-verified, installed, and relaunched automatically.</p>
