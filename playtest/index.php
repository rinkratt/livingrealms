...
$downloadPath = dirname(__DIR__) . '/downloads/LivingRealms-Playtest-Windows-0.9.18.zip';
...
<div>
<p class="eyebrow">Build 0.9.18</p><h2>A shared world is waiting.</h2>
...
<h3>What changed in 0.9.18</h3><p>Elowen now has her own detailed healer and herbalist character based on the supplied magic-girl Blender artwork. Her optimized PBR textures, witch hat, clothing, hair, movement, herb staff, dialogue, tonic trading, and medical support are included.</p>
<h3>Automatic updates</h3><p>Build 0.9.18 checks for future builds when it starts. New packages are downloaded from living-realms.com, checksum-verified, installed, and relaunched automatically.</p>
