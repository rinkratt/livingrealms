...
$downloadPath = dirname(__DIR__) . '/downloads/LivingRealms-Playtest-Windows-0.9.14.zip';
...
<div>
<p class="eyebrow">Build 0.9.14</p><h2>A shared world is waiting.</h2>
...
<h3>What changed in 0.9.14</h3><p>Survival now uses real population and worker activity. Every resident and goblin consumes food; named farmers, fishermen, and hunters produce it; settlements recruit workers needed to correct shortages; and persistent wildlife supports hunting and territorial clashes. Journey shows the complete food balance for both factions.</p>
<h3>Automatic updates</h3><p>Build 0.9.14 checks for future builds when it starts. New packages are downloaded from living-realms.com, checksum-verified, installed, and relaunched automatically.</p>
