...
$downloadPath = dirname(__DIR__) . '/downloads/LivingRealms-Playtest-Windows-0.9.11.zip';
...
<div>
<p class="eyebrow">Build 0.9.11</p><h2>A shared world is waiting.</h2>
...
<h3>What changed in 0.9.11</h3><p>Ready campaigns now appear green on the Journey page and remain paused until an online administrator authorizes them. Attackers spread around targets, combat request spikes recover automatically, successor goblin leaders remain visibly marked, and roaming dragons recover from stalled routes.</p>
<h3>Automatic updates</h3><p>Build 0.9.11 checks for future builds when it starts. New packages are downloaded from living-realms.com, checksum-verified, installed, and relaunched automatically.</p>
