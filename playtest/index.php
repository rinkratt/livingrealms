...
$downloadPath = dirname(__DIR__) . '/downloads/LivingRealms-Playtest-Windows-0.9.17.zip';
...
<div>
<p class="eyebrow">Build 0.9.17</p><h2>A shared world is waiting.</h2>
...
<h3>What changed in 0.9.17</h3><p>A completely destroyed Stonehaven or Darkwood now remains defeated for fifteen real minutes. Its founding population then returns and rebuilds stockpiles, farms, buildings, the mine, and the dock before repairing gates and walls. Repairs consume real settlement materials, growth resumes from the founders, and Journey shows the live recovery countdown and repair progress.</p>
<h3>Automatic updates</h3><p>Build 0.9.17 checks for future builds when it starts. New packages are downloaded from living-realms.com, checksum-verified, installed, and relaunched automatically.</p>
