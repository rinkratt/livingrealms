...
$downloadPath = dirname(__DIR__) . '/downloads/LivingRealms-Playtest-Windows-0.9.7.zip';
...
<div>
<p class="eyebrow">Build 0.9.7</p><h2>A shared world is waiting.</h2>
...
<h3>What changed in 0.9.7</h3><p>A full-size animated dragon is now available for visual review at a dedicated, non-hostile roost in grid C1, Willowmere. The viewing area has been cleared and includes a marked path, boundary stones, collision, and in-world model attribution.</p>
<h3>Automatic updates</h3><p>Build 0.9.7 checks for future builds when it starts. New packages are downloaded from living-realms.com, checksum-verified, installed, and relaunched automatically.</p>
