...
$downloadPath = dirname(__DIR__) . '/downloads/LivingRealms-Playtest-Windows-0.9.10.zip';
...
<div>
<p class="eyebrow">Build 0.9.10</p><h2>A shared world is waiting.</h2>
...
<h3>What changed in 0.9.10</h3><p>Persistent creatures no longer fall below unloaded map grids, restoring the visible A1 training animals and Darkwood goblins. Selected creatures also receive a bright gold ground ring for clear confirmation in combat.</p>
<h3>Automatic updates</h3><p>Build 0.9.10 checks for future builds when it starts. New packages are downloaded from living-realms.com, checksum-verified, installed, and relaunched automatically.</p>
