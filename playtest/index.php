...
$downloadPath = dirname(__DIR__) . '/downloads/LivingRealms-Playtest-Windows-0.9.15.zip';
...
<div>
<p class="eyebrow">Build 0.9.15</p><h2>A shared world is waiting.</h2>
...
<h3>What changed in 0.9.15</h3><p>Iron now comes only from Irondeep in A3. Dain and a named Darkwood miner physically travel there, carry ore home, and spend delivered iron on persistent weapon and armor tiers. Stonehaven hires two named mine guards when Darkwood contests A3 and pays each one five gold per world day. Journey shows the shared vein, both hauling operations, equipment, guard names, payroll, and treasury.</p>
<h3>Automatic updates</h3><p>Build 0.9.15 checks for future builds when it starts. New packages are downloaded from living-realms.com, checksum-verified, installed, and relaunched automatically.</p>
