...
$downloadPath = dirname(__DIR__) . '/downloads/LivingRealms-Playtest-Windows-0.9.6.zip';
...
<div>
<p class="eyebrow">Build 0.9.6</p><h2>A shared world is waiting.</h2>
...
<h3>What changed in 0.9.6</h3><p>This hotfix makes server creatures load reliably when the game starts. The five named training creatures in A1 and Darkwood's living goblin population in C3 now load before the remaining world panels, and server requests can no longer overwrite one another during startup.</p>
<h3>Automatic updates</h3><p>Build 0.9.6 checks for future builds when it starts. New packages are downloaded from living-realms.com, checksum-verified, installed, and relaunched automatically.</p>
