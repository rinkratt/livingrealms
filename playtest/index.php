...
$downloadPath = dirname(__DIR__) . '/downloads/LivingRealms-Playtest-Windows-0.9.8.zip';
...
<div>
<p class="eyebrow">Build 0.9.8</p><h2>A shared world is waiting.</h2>
...
<h3>What changed in 0.9.8</h3><p>The persistent creature roster now uses a more reliable startup request with automatic retries, restoring the A1 training creatures and visible C3 Darkwood population. Large creature populations save movement in safe batches. The non-hostile C1 dragon now cycles through Idle, Walk, Run, and Fly for review.</p>
<h3>Automatic updates</h3><p>Build 0.9.8 checks for future builds when it starts. New packages are downloaded from living-realms.com, checksum-verified, installed, and relaunched automatically.</p>
